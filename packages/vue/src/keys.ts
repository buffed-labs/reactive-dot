...
export const configKey = Symbol("config") as InjectionKey<MaybeRefOrGetter<Config>>;

export const chainIdKey = Symbol("chainId") as InjectionKey<MaybeRefOrGetter<ChainId>>;
