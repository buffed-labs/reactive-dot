...
To handle complexity around [planck unit](https://wiki.polkadot.network/docs/learn-DOT#the-planck-unit) used in Polkadot, a utility class [`MonetaryNumber`](/react/api/utils/classes/MonetaryNumber) is provided by [`@reactive-dot/utils`](https://reactivedot.dev/api/utils).
