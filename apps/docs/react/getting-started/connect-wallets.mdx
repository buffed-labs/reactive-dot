...
Wallets & accounts connection can by managed via [`useWallets`](/react/api/react/functions/useWallets), [`useConnectedWallets`](/react/api/react/functions/useConnectedWallets) & [`useAccounts`](/react/api/react/functions/useAccounts) hooks.
